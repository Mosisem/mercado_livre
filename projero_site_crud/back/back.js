...
function click_p1(){
    window.document.location.href="projero_site_crud/doc_pg2.html"
}

function click_p2(){
    window.document.location.href="projero_site_crud/doc_pg3.html"
}

function click_p3(){
    window.document.location.href="projero_site_crud/doc_pg4.html"
}

function click_p4(){
    window.document.location.href="projero_site_crud/doc_pg5.html"
}

function click_p5(){
    window.document.location.href="projero_site_crud/doc_pg6.html"
}

function click_p6(){
    window.document.location.href="projero_site_crud/doc_pg7.html"
}

function click_p7(){
    window.document.location.href="projero_site_crud/doc_pg8.html"
}

function click_p8(){
    window.document.location.href="projero_site_crud/doc_pg9.html"
}

function click_p9(){
    window.document.location.href="projero_site_crud/doc_pg10.html"
}

function click_p01(){
    window.document.location.href="html.css_pg/doc_pg_1.html"
}

function click_p_home(){
