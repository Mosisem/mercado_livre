const minitwitter = {
 ...
 criapost(dados){
    ...
    <li class="elementohtnl" id="elementohtnl">
...
var nome_p = ""
var p_v =""
//window.document.getElementById("input_p").value
//    console.log("poste novo")
...
//form.addEventListener("submit", function criapostecontroller(infeventos){
//infeventos.preventDefault();  


//var input_pro = document.getElementById("input_p").value

//});

// ===============   deletar  
function deletador(){
        var elemento =window.document.getElementById("elementohtnl")
